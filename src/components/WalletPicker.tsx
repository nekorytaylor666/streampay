...
const WalletPicker = forwardRef<ModalRef>(({}, ref) => {
  ...
  return (
    ...
    >
      <div
        className="w-11/12 sm:w-96 xl:w-1/3 2xl:w-1/4 px-4 pb-3 pt-7 sm:px-6 rounded-md bg-gradient-to-br to-ternary from-gray-800 flex flex-col"
      ...
      >
        {walletTypes.map((wallet) => (
          ...
          >
            ...
            <p className="inline-block">{wallet.name}</p>
          </button>
        ))}
      </div>
    </div>
